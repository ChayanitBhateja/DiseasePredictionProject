...
import SendPrediction from "../components/SendPrediction";

const AcceptedPatients = () => {
  const [changePasswordShow, setChangePasswordShow] = useState(false);
  const [sendPredictionShow, setSendPredictionShow] = useState(false);
  ...
  function removePatientFunction(id) {
    removePatient(id)
      .then((response) => {
  ...
  function allPatientFunction(search, limit, pageNumber) {
    getAllAcceptedPatient(search, limit, pageNumber).then((response) => {
      console.log(response, "ient");
      setUsers(response.data.data.doctor.patients);
                          ...
                          <td>
                            <Dropdown>
                              ...
                              <Dropdown.Menu>
                                ...
                                <Dropdown.Item
                                  onClick={() => {
                                    removePatientFunction(item._id);
                                  }}
                                >
                                  Remove Patient
                                </Dropdown.Item>
