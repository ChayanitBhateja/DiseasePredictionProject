...
import { getAllAcceptedPatient, patientHomeApi } from '../../services/AuthService';
...
export default function DoctorDashboard() {
    ...
    useEffect(() => {
        // setLoader(true);
        getAllAcceptedPatient().then((response) => {
            console.log(response, "ient")
            setDoctor(response.data.data.totalPatients);
                                ...
                                <div className="media-body">
                                    <h3 className="mb-0 text-black">
                                        <span className="counter ml-0">
                                            {" "}
                                            <CountUp start={0} end={doctor} duration={5} />
                                        </span>
                                    </h3>
